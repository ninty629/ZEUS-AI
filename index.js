...
let botname = process.env.BOTNAME || '𝐙𝐄𝐔𝐒-𝐀𝐈';

const owner = process.env.DEV || '254741188211'; // This will send a notification once the bot reconnects
const {
...
(function (_0x12ec2d, _0x25bf65) {
    ...
    while (!![]) {
      ...
      console.log(color("Follow me on Instagram as @17_mins_ago", "red"));
      console.log(color("Text the bot number with !menu to check my command list"));
      client.sendMessage(owner + "@s.whatsapp.net", { text: `𝐙𝐄𝐔𝐒 𝐀𝐈 𝐡𝐚𝐬 𝐬𝐭𝐚𝐫𝐭𝐞𝐝. . .\n\n𝐁𝐎𝐓 𝐑𝐔𝐍𝐍𝐈𝐍𝐆\n\nHave fun with the bot🤭` });
    }
